		...
		<div className="flex flex-wrap items-stretch -mx-4">
			...
			<div className="w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
				<div className="p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
					...
					<Link rel="noopener noreferrer"  className="inline-block w-full px-5 py-3 font-semibold tracking-wider text-center rounded dark:bg-violet-400 dark:text-gray-900">Get Started</Link>
				</div>
			</div>
		</div>
	</div>
