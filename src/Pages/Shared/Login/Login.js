...
const handleForm = (e) => {
 ...
 signin(email, password).then((userCredential) => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse mx-20">
      ...
      <div className="card-body">
        ...
        <div className="form-control">
          ...
          <input type="password" name='password' placeholder="password" className="input input-bordered" />
            ...
            <div to="#" className=""><small>If you hav'nt Account?</small> <Link to="/signup">SignUp</Link> </div>
	...
	<div onClick={handleGoogleSignIn} className="flex cursor-pointer justify-center bg-gray-500 rounded-md space-x-4">
